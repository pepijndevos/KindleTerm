...
public class KindleTerminal 
    ...
    private static final int INPUT_MODE_ALTCHR = 1;
    private static final int INPUT_MODE_CTRL = 2;
    private static final int INPUT_MODE_ALT = 3;
    private static final int INPUT_MODE_ALTCTRL = 4;
    private static final int INPUT_MODE_MAX = 4;

    protected int inputmode = INPUT_MODE_NORMAL;
    protected boolean ctrlmode = false;
     ...
     * @param buffer
     */
    public KindleTerminal(VT320 buffer, Session session, KindletContext ctx) {
        ...
        fgcolor = ctx.getUIResources().getColor(KColorName.BLACK);
        bgcolor = ctx.getUIResources().getColor(KColorName.WHITE);
        ...
        this.redrawer = new Redrawer(250, 2000, this);
        redrawer.start();
...
//    }
    ...
    public void keyTyped(KeyEvent e) {
        if(!ctrlmode && (inputmode == INPUT_MODE_NORMAL)) {
            buffer.keyTyped(0, e.getKeyChar(), 0);
        } else if(ctrlmode || (inputmode == INPUT_MODE_ALTCHR)) {
            switch(e.getKeyChar()) {
                // 1st row
                case 'q': buffer.keyTyped(0, '!', 0); break;
                case 'w': buffer.keyTyped(0, '@', 0); break;
                case 'e': buffer.keyTyped(0, '#', 0); break;
                case 'r': buffer.keyTyped(0, '$', 0); break;
                case 't': buffer.keyTyped(0, '%', 0); break;
                case 'y': buffer.keyTyped(0, '^', 0); break;
                case 'u': buffer.keyTyped(0, '&', 0); break;
                case 'i': buffer.keyTyped(0, '*', 0); break;
                case 'o': buffer.keyTyped(0, '(', 0); break;
                case 'p': buffer.keyTyped(0, ')', 0); break;

                // 2nd row
                case 'a': buffer.keyTyped(0, '\u001B', 0); break;
                case 's': buffer.keyTyped(0, '\t', 0); break;
                //case 'd': buffer.keyTyped(0, ' ', 0); break;
                //case 'f': buffer.keyTyped(0, ' ', 0); break;
                //case 'g': buffer.keyTyped(0, ' ', 0); break;
                case 'h': buffer.keyTyped(0, '[', 0); break;
                case 'j': buffer.keyTyped(0, ']', 0); break;
                case 'k': buffer.keyTyped(0, '-', 0); break;
                case 'l': buffer.keyTyped(0, '=', 0); break;

                //case 'A': buffer.keyTyped(0, '0', 0); break;
                //case 'S': buffer.keyTyped(0, '0', 0); break;
                //case 'D': buffer.keyTyped(0, ' ', 0); break;
                //case 'F': buffer.keyTyped(0, ' ', 0); break;
                //case 'G': buffer.keyTyped(0, ' ', 0); break;
                case 'H': buffer.keyTyped(0, '{', 0); break;
                case 'J': buffer.keyTyped(0, '}', 0); break;
                case 'K': buffer.keyTyped(0, '_', 0); break;
                case 'L': buffer.keyTyped(0, '+', 0); break;

                // 3rd row
                case 'z': buffer.keyTyped(0, '/', 0); break;
                case 'x': buffer.keyTyped(0, '\\', 0); break;
                case 'c': buffer.keyTyped(0, '~', 0); break;
                //case 'v': buffer.keyTyped(0, '', 0); break;
                case 'b': buffer.keyTyped(0, '`', 0); break;
                case 'n': buffer.keyTyped(0, '\'', 0); break;
                case 'm': buffer.keyTyped(0, ';', 0); break;
                case '.': buffer.keyTyped(0, ',', 0); break;

                case 'Z': buffer.keyTyped(0, '?', 0); break;
                case 'X': buffer.keyTyped(0, '|', 0); break;
                //case 'C': buffer.keyTyped(0, '0', 0); break;
                //case 'V': buffer.keyTyped(0, '0', 0); break;
                //case 'B': buffer.keyTyped(0, '0', 0); break;
                case 'N': buffer.keyTyped(0, '"', 0); break;
                case 'M': buffer.keyTyped(0, ':', 0); break;
            }
            ...
            buffer.keyTyped(0, e.getKeyChar(), VT320.KEY_CONTROL);
            inputmode = INPUT_MODE_NORMAL;
            context.setSubTitle("");
        } else if(inputmode == INPUT_MODE_ALT) {
            buffer.keyTyped(0, e.getKeyChar(), VT320.KEY_ALT);
            inputmode = INPUT_MODE_NORMAL;
            context.setSubTitle("");
        } else if(inputmode == INPUT_MODE_ALTCTRL) {
            buffer.keyTyped(0, e.getKeyChar(), VT320.KEY_CONTROL + VT320.KEY_ALT);
            inputmode = INPUT_MODE_NORMAL;
            context.setSubTitle("");
        }
    }
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (code == KindleKeyCodes.VK_TEXT) {
            ctrlmode = true;
        } else if (code == KindleKeyCodes.VK_SYMBOL) {
